    ...
    <div className="flex min-h-screen items-center justify-center bg-radial from-gray-950 via-zinc-950 to-zinc-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-panel p-8 rounded-2xl shadow-2xl relative border border-white/10">
          ...
          <p className="text-zinc-400 text-sm mb-6">Enter your details to sign in to your account</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-zinc-900/50 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-hidden focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm"
                  required
                />
              </div>
            </div>
          ...
          <div className="mt-8 text-center text-xs text-zinc-400">
            ...
            <Link to="/signup" className="text-purple-400 hover:text-purple-300 font-semibold transition-all">
              Sign up for free
            </Link>
          </div>
        </div>
